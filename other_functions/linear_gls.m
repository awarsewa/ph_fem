function zout = linear_gls(X, DX, tspan, zin, s, tout, tol, maxiter, varargin)
%GLS S-stage Gauss-Legendre solver, symplectic method. Modified for linear
%systems (increased speed).
...
jacobian = inv(DF(zeros(Nz*s, 1), DX, 0, hspan(1), s, a, c, Nz, varargin{:}));
